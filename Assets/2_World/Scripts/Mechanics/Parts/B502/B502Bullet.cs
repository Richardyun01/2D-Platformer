...
public class B502Bullet : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.tag == "Platform" || collision.gameObject.tag == "OneWayPlatform" || collision.gameObject.tag == "Enemy" || collision.gameObject.tag == "BreakablePlatform")
        {
